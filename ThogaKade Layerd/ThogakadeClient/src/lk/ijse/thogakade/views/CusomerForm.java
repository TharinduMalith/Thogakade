 ...
 * @author Dilshan
 */
public class CusomerForm extends javax.swing.JFrame implements Observer {
...
DefaultTableModel dtm=(DefaultTableModel) tblItem.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CusomerForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CusomerForm().setVisible(true);
            }
        });
    }
